...
public class BaseFilter {
    ...
    // 每个顶点坐标有几个参数
    protected int mCoordsPerVertex = OpenGLUtil.CoordsPerVertex;
    // 顶点坐标数量
    protected int mVertexCount = OpenGLUtil.vertextData.length / mCoordsPerVertex;
    ...
    public void initProgramHandle() {
        ...
        if (!TextUtils.isEmpty(mVertexShader) && !TextUtils.isEmpty(mFragmentShader)) {
            ...
            mPositionHandle = OpenGLUtil.GL_NOT_INIT;
            mTextureCoordinateHandle = OpenGLUtil.GL_NOT_INIT;
            mInputTextureHandle = OpenGLUtil.GL_NOT_TEXTURE;
    ...
    public boolean drawFrame(int textureId, FloatBuffer vertexBuffer,
        ...
        if (!mIsInitialized || textureId == OpenGLUtil.GL_NOT_INIT || !mFilterEnable) {
            return false;
        }
    ...
    public int drawFrameBuffer(int textureId, FloatBuffer vertexBuffer, FloatBuffer textureBuffer) {
        ...
        if (textureId == OpenGLUtil.GL_NOT_TEXTURE || mFrameBuffers == null
    ...
    public void release() {
        if (mIsInitialized) {
            ...
            mProgramHandle = OpenGLUtil.GL_NOT_INIT;
        }
        destroyFrameBuffer();
    }
    ...
    public void initFrameBuffer(int width, int height) {
        ...
        if (mFrameBuffers == null) {
            ...
            OpenGLUtil.createFrameBuffer(mFrameBuffers, mFrameBufferTextures, width, height);
        }
    }
